const TABLES = [
  ["Students","Students"],["attendance","Attendance"],["fee_payments","Fee Payments"],
  ["parents","Parents"],["results","Results"],["school_classes","School Classes"],
  ["student_parents","Student Parents"],["subjects","Subjects"],["teachers","Teachers"]
];

let client=null, currentTable=null, rows=[], columns=[], editingId=null;
...
function init(){
  ...
  if(!c.SUPABASE_URL||c.SUPABASE_URL.includes("PASTE_")||!c.SUPABASE_ANON_KEY||c.SUPABASE_ANON_KEY.includes("PASTE_")){
